      ...
      <Transition name="fade" mode="out-in">
        ...
        >
          <div class="lg:col-span-1">
            <div
              class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col items-center animate-pulse"
            >
              <div class="w-28 h-28 rounded-full bg-gray-200 mb-5"></div>
              <div class="h-6 w-3/4 bg-gray-200 rounded mb-2"></div>
              <div class="h-4 w-1/2 bg-gray-100 rounded mb-8"></div>
            ...
            <div class="space-y-4 animate-pulse">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div
                  v-for="i in 4"
                  :key="i"
                  class="h-32 bg-gray-100 rounded-2xl border border-gray-200"
                ></div>
              </div>
            </div>
          </div>
